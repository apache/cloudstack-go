...
//
//	mockgen -destination=./cloudstack/ConsoleEndpointService_mock.go -package=cloudstack -copyright_file=header.txt -source=./cloudstack/ConsoleEndpointService.go
//
...
func (mr *MockConsoleEndpointServiceIfaceMockRecorder) CreateConsoleEndpoint(p any) *gomock.Call {
...
func (mr *MockConsoleEndpointServiceIfaceMockRecorder) NewCreateConsoleEndpointParams(virtualmachineid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
