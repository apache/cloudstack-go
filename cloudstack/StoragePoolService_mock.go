...
func (mr *MockStoragePoolServiceIfaceMockRecorder) GetAffectedVmsForStorageScopeChangeID(keyword, clusterid, storageid interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoragePoolServiceIfaceMockRecorder) ListAffectedVmsForStorageScopeChange(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoragePoolServiceIfaceMockRecorder) NewListAffectedVmsForStorageScopeChangeParams(clusterid, storageid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
