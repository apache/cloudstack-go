...
func (mr *MockPodServiceIfaceMockRecorder) CreateManagementNetworkIpRange(p interface{}) *gomock.Call {
...
func (mr *MockPodServiceIfaceMockRecorder) DeleteManagementNetworkIpRange(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodServiceIfaceMockRecorder) NewCreateManagementNetworkIpRangeParams(gateway, netmask, podid, startip interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodServiceIfaceMockRecorder) NewDeleteManagementNetworkIpRangeParams(endip, podid, startip, vlan interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
