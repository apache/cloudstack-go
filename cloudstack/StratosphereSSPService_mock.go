...
//
//	mockgen -destination=./cloudstack/StratosphereSSPService_mock.go -package=cloudstack -copyright_file=header.txt -source=./cloudstack/StratosphereSSPService.go
//
...
func (mr *MockStratosphereSSPServiceIfaceMockRecorder) AddStratosphereSsp(p any) *gomock.Call {
...
func (mr *MockStratosphereSSPServiceIfaceMockRecorder) DeleteStratosphereSsp(p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStratosphereSSPServiceIfaceMockRecorder) NewAddStratosphereSspParams(name, url, zoneid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStratosphereSSPServiceIfaceMockRecorder) NewDeleteStratosphereSspParams(hostid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
