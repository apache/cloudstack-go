...
func (mr *MockSnapshotServiceIfaceMockRecorder) CreateSnapshotFromVMSnapshot(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotServiceIfaceMockRecorder) ExtractSnapshot(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotServiceIfaceMockRecorder) NewCreateSnapshotFromVMSnapshotParams(vmsnapshotid, volumeid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotServiceIfaceMockRecorder) NewExtractSnapshotParams(id, zoneid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
